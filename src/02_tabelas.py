...
tab_pessoal = pd.DataFrame(tab_pessoal).to_csv(CAMINHO + '02_pessoal.csv', encoding='utf-8', index=False, sep='|')
tab_outros = pd.DataFrame(tab_outros).to_csv(CAMINHO + '02_outros.csv', encoding='utf-8', index=False, sep='|')
tab_educacao = pd.DataFrame(tab_educacao).to_csv(CAMINHO + '02_educacao.csv', encoding='utf-8', index=False, sep='|')
tab_emprego = pd.DataFrame(tab_emprego).to_csv(CAMINHO + '02_emprego.csv', encoding='utf-8', index=False, sep='|')
tab_computacao = pd.DataFrame(tab_computacao).to_csv(CAMINHO + '02_computacao.csv', encoding='utf-8', index=False, sep='|')
tab_idioma = pd.DataFrame(tab_idioma).to_csv(CAMINHO + '02_idioma.csv', encoding='utf-8', index=False, sep='|')
tab_soft = pd.DataFrame(tab_soft).to_csv(CAMINHO + '02_soft.csv', encoding='utf-8', index=False, sep='|')
